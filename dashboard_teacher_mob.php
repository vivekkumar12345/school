...
<div class="far-school" id="far-inr" style="display: none;">
	<div class="info-slider-btn2" onclick="location.href = 'salary_list_teacher.php'">
		<i class="fab fa-cc-amazon-pay" style="font-size: 3.5vh; padding-top: 2vh; padding-bottom: 2vh;"></i><br>Confirm Payment
	</div>
	<div class="info-slider-btn2" onclick="location.href = 'pay_history_teacher.php'">
		<i class="fas fa-history" style="font-size: 3.5vh; padding-top: 2vh; padding-bottom: 2vh;"></i><br>History
	</div>
	<div class="info-slider-btn2" onclick="">
		<i class="fa fa-area-chart" style="font-size: 3.5vh; padding-top: 2vh; padding-bottom: 2vh;"></i><br>Pay chart
	</div>
</div>
