	...
	<div class="scroll-date">
		<?php
			...
			for ($i = 0; $i<90; $i++){
				...
				onclick="location.href='homework_teacher_mob.php?date=<?php echo $date ?>'">
...
<tr>
	<td colspan="2"><?php echo $row112['home_work']; ?></td>
	<td><i class="far fa-edit" style="color: blue; font-size:2vh; font-weight: bold;" onclick="location.href='homework_teacher_mob.php?clcl=<?php echo $row11['class']; ?>&clsec=<?php echo $row11['section']; ?>&clslot=<?php echo $row111['slot']; ?>&clteacherid=<?php echo $row11['by_teacher_id'];?>&clsubject=<?php echo $row11['subject'];?>&cltext=<?php echo $row112['home_work']; ?>&type=edit'"></i></td>
</tr>
...
?>
		<td><i class="far fa-edit" style="color: blue; font-size:2vh; font-weight: bold;" onclick="location.href='homework_teacher_mob.php?clcl=<?php echo $row11['class']; ?>&clsec=<?php echo $row11['section']; ?>&clslot=<?php echo $row111['slot']; ?>&clteacherid=<?php echo $row11['by_teacher_id'];?>&clsubject=<?php echo $row11['subject'];?>&cltext=<?php echo '' ?>&type=insert'"></i>
	<?php
}
else{
...
<div style="background-color: rgba(0, 160, 190, 0.9);; height:100vh; width:100%; position: fixed; top:0; left:0; transition: all 1s ease-in;">
	<div style="height: 50vh; width: 80%; background-color: black; border-radius:2vh; margin-left: 10%; margin-top:15vh; text-align: center;">
		<form action="homework_teacher_mob_exe.php" method="POST">
