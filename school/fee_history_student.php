...
<br>
<a style="line-height: 3vh; font-family:'Oswald', sans-serif; font-size: 2.2vh;">Paid On : <?php echo $r2['payment_date_time']; ?></a>
<br>
<a style="line-height: 3vh; font-family:'Oswald', sans-serif; font-size: 2.2vh;">Mode : <?php echo $r2['method_payment']; ?></a>
</div>
<?php
}
else{
